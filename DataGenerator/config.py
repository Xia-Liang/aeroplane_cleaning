...
def generate_lidar_bp(world, blueprint_library):
    ...
    lidar_bp.set_attribute("lower_fov", "-60")  # Angle in degrees of the lowest laser.
    return lidar_bp
...
def generate_lidar_sem_bp(world, blueprint_library):
    ...
    lidar_sem_bp.set_attribute("points_per_second", "500000")  # Points generated by all lasers per second. default 56000
    lidar_sem_bp.set_attribute("rotation_frequency", "10")  # Lidar rotation frequency. default 10
    lidar_sem_bp.set_attribute("upper_fov", "60")  # Angle in degrees of the highest laser.
    lidar_sem_bp.set_attribute("lower_fov", "-60")  # Angle in degrees of the lowest laser.
    return lidar_sem_bp
