...
def generate_lidar_bp(world, blueprint_library):
    ...
    lidar_bp.set_attribute("range", "150.0")  # Maximum distance to measure/raycast in meters
    lidar_bp.set_attribute("points_per_second", "80000")  # Points generated by all lasers per second. default 56000
...
def generate_lidar_sem_bp(world, blueprint_library):
    ...
    lidar_sem_bp.set_attribute("channels", "64")  # Number of lasers.
    lidar_sem_bp.set_attribute("range", "150.0")  # Maximum distance to measure/raycast in meters
    lidar_sem_bp.set_attribute("points_per_second", "100000")  # Points generated by all lasers per second. default 56000
