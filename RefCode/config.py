...
def generate_lidar_bp(world, blueprint_library):
    ...
    lidar_bp.set_attribute("range", "200.0")  # Maximum distance to measure/raycast in meters
...
def generate_lidar_sem_bp(world, blueprint_library):
    ...
    lidar_sem_bp.set_attribute("range", "200.0")  # Maximum distance to measure/raycast in meters
    lidar_sem_bp.set_attribute("points_per_second", "80000")  # Points generated by all lasers per second. default 56000
